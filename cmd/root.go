...
var RootCmd = &cobra.Command{
	Use:   "gdocs",
	Short: "Google Sheets interaction cli",
	Long: ``,
...
func init() {
	...
	RootCmd.PersistentFlags().StringVarP(&initFile, "file", "f", "", "init file ")
...
func initConfig() {
	...
	viper.SetConfigName(".gdocs") // name of config file (without extension)
